...
namespace ProjectManagementSystem.Controllers
{
    public class ChecklistController : Controller
    {
        ...
        public JsonResult AddProjectUpload()
        {
            ...
            {
                return Json(new { message = "No file uploaded or file is empty", status = false }, JsonRequestBehavior.AllowGet);
            }
                            ...
                            foreach (var milestone in milestoneList) 
                            {
                                ...
                                foreach (var taskGroup in groupedTasks)
                                {
                                    ...
                                    var addTask = new DetailsTbl
                                    {
                                        ...
                                        start_date = taskGroup.StartDate,
                                        end_date = taskGroup.EndDate,
